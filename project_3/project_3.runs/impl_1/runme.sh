...
HD_PWD='D:/Xilinx/workspace/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FA_HA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FA_HA.tcl -notrace
