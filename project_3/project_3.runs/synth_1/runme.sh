...
HD_PWD='D:/Xilinx/workspace/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FA_HA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FA_HA.tcl
