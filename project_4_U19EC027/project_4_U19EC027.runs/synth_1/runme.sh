...
HD_PWD='D:/Xilinx/workspace/project_4_U19EC027/project_4_U19EC027.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MUX_16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MUX_16.tcl
