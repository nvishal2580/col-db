...
HD_PWD='D:/Xilinx/workspace/project_4_U19EC027/project_4_U19EC027.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MUX_16.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MUX_16.tcl -notrace
